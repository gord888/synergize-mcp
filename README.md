...
[![CI](https://github.com/gord888/synergize-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/gord888/synergize-mcp/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/gord888/synergize-mcp)](https://github.com/gord888/synergize-mcp/releases)
...
### 2c. Install from a release

Download a wheel from the [Releases page](https://github.com/gord888/synergize-mcp/releases) and install with `pipx` or `pip`:

```bash
pipx install ./synergize_mcp-1.0.0-py3-none-any.whl
```
